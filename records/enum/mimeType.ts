/*
 * @Author: liu7i
 * @Date: 2022-08-10 13:52:50
 * @Last Modified by: liu7i
 * @Last Modified time: 2022-08-10 14:00:32
 */

/**
 * @enum tips 媒体类型（也称为多用途 Internet 邮件扩展或 MIME 类型）指示文档、文件或字节分类的性质和格式 。MIME 类型在 IETF 的RFC 6838中定义和标准化。
